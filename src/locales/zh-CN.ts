export default {
  ...
  // ===== B 扩展（一键启动栈 Stack） =====
  stacks: '栈',
  stacksDesc: '一键启动 / 停止 / 重启跨模块服务栈',
  noStacks: '还没有栈，点击「新建栈」开始',
  createStack: '新建栈',
  editStack: '编辑栈',
  deleteStack: '删除栈',
  startStack: '启动',
  ...
  addMember: '添加成员',
  dragToSort: '拖拽调整顺序（同层按 order 升序）',
  dependsOnHint: '该成员会在其依赖的成员之后启动',
  cycleDetected: '检测到循环依赖，请修正 depends_on 后重试',
  saveStack: '保存栈',
  confirmDeleteStack: '确定删除该栈？此操作不可撤销。',
  memberStatus: '成员状态',
  stackStatus: '栈状态',
  stackStarting: '启动中',
  stackRunning: '运行中',
