export default {
  ...
  gcUnsupported: ' (unsupported on this JDK)',
  gcUnsupportedSelected: 'Java {n} does not support {gc}; the app would fail to start (Unrecognized VM option). Pick another GC.',
