export default {
  ...
  // ===== B 扩展（一键启动栈 Stack） =====
  stacks: 'Stacks',
  stacksDesc: 'One-click start / stop / restart of cross-module service stacks',
  noStacks: 'No stacks yet. Click "New Stack" to start.',
  ...
  dragToSort: 'Drag to reorder (same layer ordered by `order` ascending)',
  dependsOnHint: 'This member starts after the members it depends on',
  cycleDetected: 'Circular dependency detected. Fix depends_on and retry.',
  saveStack: 'Save Stack',
  confirmDeleteStack: 'Delete this stack? This cannot be undone.',
  ...
  noMembers: 'This stack has no members',
