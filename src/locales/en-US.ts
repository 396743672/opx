export default {
  ...
  gracefulStopUrlHint: 'Leave empty to derive it from the app port. The app must expose the shutdown endpoint, otherwise it is force-killed without waiting. enabled=true on 2.x/3.x, access=unrestricted on 4.x, and both need it in management.endpoints.web.exposure.include',
