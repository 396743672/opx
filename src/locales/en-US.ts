export default {
  ...
  gracefulStopUrlHint: 'Leave empty to derive it from the app port. The app must expose the shutdown endpoint (off by default): add it to management.endpoints.web.exposure.include and enable it — enabled=true on 2.x/3.x, access=unrestricted on 4.x',
