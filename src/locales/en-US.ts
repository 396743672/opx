export default {
  ...
  acmeNeedIssue: 'HTTPS stays off until a certificate is issued',
  ...
  noStartupReport: 'No startup report yet',
  startupAllOk: 'All started successfully',
  startupFailedCount: '{n} failed to start',
  failed: 'Failed',
